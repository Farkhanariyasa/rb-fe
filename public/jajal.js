(function (n) {
    let e = function () {
        ...
        o = function () {
            let f = function (n) {
                    ...
                    if (
                        ...
                        if (r === "string") n !== "" && this._fromString(n);
            ...
            t.forEach = function (n, t) {
                ...
                for (i in this._entries)
                    if (this._entries.hasOwnProperty(i))
                        for (u = this._entries[i], r = 0; r < u.length; r++)
                            n.call(t, u[r], i, this);
            };
            t.keys = function () {
                let n = [];
        ...
        s = function () {
            try {
                let t = n.URLSearchParams;
                return (
                    new t("?a=1").toString() === "a=1" &&
                    typeof t.prototype.set == "function"
                );
            } catch (i) {
                return !1;
            }
        ...
        let i = function () {
            ...
            r = function () {
                let t = n.URL,
                    i = function (t, i) {
                        ...
                        if (
                            ((r = u.createElement("a")),
                            (r.href = t),
                            f && (u.body.appendChild(r), (r.href = r.href)),
                        ...
                        let e = new n.URLSearchParams(this.search),
                            s = !0,
                            h = !0,
                            a = this;
                ...
                Object.defineProperties(r, {
                    ...
                    origin: {
                        get: function () {
                            let n = { "http:": 80, "https:": 443, "ftp:": 21 }[
                                    this._anchorElement.protocol
                                ],
                                t =
                                    this._anchorElement.port != n &&
            ...
            t;
        if ((i() || r(), n.location !== void 0 && !("origin" in n.location))) {
            t = function () {
                return (
                    n.location.protocol +
                    "//" +
                    n.location.hostname +
                    (n.location.port ? ":" + n.location.port : "")
                );
            };
            try {
        ...
        (window.tableau = window.tableau || {}),
            (function (n) {
                function t() {
                    ...
                    for (i, n, r, t = r.length - 1; t >= 0; t -= 1)
                        if (((i = r[t]), /viz_v1\.js/.test(i.src))) break;
                    return (
                        (n = new RegExp(".*?[^/:]/").exec(i.src)),
                        (n &&
                            (n[0].toLowerCase().indexOf("http://") !== -1 ||
                                n[0].toLowerCase().indexOf("https://") !==
                                    -1)) ||
                            (n = new RegExp(".*?[^/:]/").exec(
            ...
            (function () {
                ...
                function tt(n, t) {
                    return (
                        n &&
                        n.nodeType === ot &&
                        n.tagName.toLowerCase() === t.toLowerCase()
                    );
                }
                function it(n, t) {
                    return (
                ...
                function o(n, t) {
                    ...
                    return u(n)
                        ? t
                        : ((i = n.match(/^(yes|y|true|t|1)$/i)), !u(i));
                }
                function ht(n) {
                    let t,
                        i,
                        r = [];
                    if (u(n.filter)) return "";
                    for (t = 0, i = n.filter.length; t < i; t++)
                        r.push("&" + n.filter[t]);
                    return r.join("");
                }
                function ct(n) {
                ...
                function rt(n) {
                    ...
                    return (
                        (t = u(n.host_url)
                            ? u(n.serverRoot)
                                ? tableau._apiScripts[0]
                                : n.serverRoot
                            : decodeURIComponent(n.host_url)),
                        (r = new RegExp(".*//")),
                        (f = new RegExp(
                            "https?://[-A-Za-z0-9]*public[-A-Za-z0-9]*\\.tableau"
                        )),
                        (i =
                            r.exec(window.location.href) &&
                            r.exec(window.location.href)[0]),
                        i &&
                            i.indexOf("file://") === -1 &&
                            t.indexOf(i) === -1 &&
                            t.match(f) !== null &&
                    ...
                    return (
                        ...
                        n
                            ...
                            : ((n = a(document.documentElement)),
                              ...
                              t &&
                                  ((n.height =
                                      document.body.clientHeight - n.left),
                                  (n.width =
                                      document.body.clientWidth - n.top)),
                              (n.left += d()),
                              (n.top += g()),
                              n)
                    );
                ...
                function wt(n) {
                    for (
                        let r, u, i = a(n), t = n.parentElement;
                        t && t.parentElement;
                        t = t.parentElement
                    )
                        (r = f(t).overflow),
                ...
                function bt(n, t) {
                    let i = tableau.vizs[n]._loadOrder,
                        r = tableau.vizs[t]._loadOrder;
                    return i < r ? -1 : i === r ? 0 : 1;
                }
                function w(n) {
                    let t = n > -1 ? tableau.vizs[r[n]] : null;
                    t && t._onLoaded();
                }
                function c(n) {
                    let i, u;
                ...
                function l(n) {
                    ...
                    if (
                        n.data &&
                        (typeof n.data == "string" || n.data instanceof String)
                    )
                        if (
                            ((o = n.data.split(",")),
                            (f = o[0]),
                            ...
                            f === "tableau.listening"
                                ? ((i = tableau.vizs[r[t]]),
                                  i && i._enableVisibleRectCommunication())
                                : f === "tableau.staticImageRedirect" &&
                                  ((e = parseInt(o[1], 10)),
                ...
                function ni() {
                    ...
                    function i(i) {
                        if (
                            ...
                            for (
                                let u = i.data.split(","), r = 0, f;
                                r < u.length;

                            )
                                n ||
                                    (u[r] !== "tableau.completed" &&
                                        u[r] !== "completed") ||
                                    ((n = !0), t(i.source, -1)),
                                    u[r] === "sf?" &&
                                        ((f = u[++r]), t(i.source, f)),
                ...
                function ii() {
                    for (
                        let n,
                            r = document.getElementsByTagName("object"),
                            u = [],
                            t = 0,
                            i = r.length;
                        t < i;
                ...
                function ri(n) {
                    for (
                        let r = window.tableau._apiScripts,
                            t = 0,
                ...
                function ui() {
                    for (
                        let n = document.getElementById("tableau_hide_this");
                        n;
                ...
                function h() {
                    let n,
                        ...
                        u = [];
                    if (((s = ii()), s.length !== 0)) {
                        for (ui(), n = 0, o = s.length; n < o; n++)
                            (e = s[n]),
                                (i = { filter: [], ticket: "", path: "" }),
                                (h = p(e, i)),
                ...
                i.prototype.getRootElement = function () {
                    return this._ensurePlaceholderDiv()
                        ? this._placeholderDiv
                        : null;
                };
                ...
                i.prototype.adjustHeightForPublic = function (n, t) {
                    return !n.embed_code_version || n.embed_code_version < 3
                        ? t - 33
                        : t;
                };
                i.prototype.sizeIframeToObjectElement = function (t) {
                    let o = this._objectElement,
                        u = {},
                        r,
                        i;
                    e(o) ||
                        ...
                        r.indexOf("%") === -1 &&
                            ...
                            ((r = parseInt(r, 10)),
                            (i = parseInt(i, 10)),
                            u.embed_code_version ||
                                ((r = this.adjustSlopInWidth(u, r)),
                ...
                const s = function (n) {
                        return typeof n == "number"
                            ? n
                            : (typeof n == "string" &&
                                  +n.substr(0, n.indexOf("px"))) ||
                                  0;
                    },
                    et = function (n, t, i) {
                        let r = n;
                        return i > 0 && r > i ? (r = i) : r < t && (r = t), r;
                    },
                ...
                i.prototype.createLoadingFeedback = function (n, t) {
                    ...
                    if (
                        ...
                        try {
                            if (
                                ((p = this.determinePlaceholderSize(
                                    this._placeholderDiv,
                                    this._objectElement
                                )),
                        ...
                        if (
                            ...
                            function n(n, t) {
                                ...
                                try {
                                    ...
                                    return (
                                        console.error(
                                            "Unable to append params to the url : " +
                                                f
                                        ),
                                        n
                                    );
                            ...
                            r.push(
                                "') no-repeat scroll 0 0; background-size: " +
                                    y(l.width + "px ") +
                                    y(l.height + "px") +
                                    "; box-shadow: none; left:0px; top:"
                            );
                            r.push(w);
                            r.push('"></div>');
                        }
                        return (
                            ...
                            this._placeholderDiv.appendChild(
                ...
                i.prototype.dispose = function () {
                    if (this._glassPaneElement) {
                        let n, t, i;
                        n = 150;
                        this._glassPaneElement.style.transition =
                            n + "ms opacity";
                    ...
                    this._objectElement &&
                        (vt(v, this._objectElement),
                        this._objectElement.parentNode.removeChild(
                            this._objectElement
                        ),
                ...
                i.prototype._ensurePlaceholderDiv = function () {
                    let n;
                    return e(this._placeholderDiv)
                        ? e(this._objectElement)
                            ? !1
                            : ((n = st(
                                  this._objectElement,
                                  "tableauPlaceholder"
                              ...
                              n ||
                                  ...
                                  this._objectElement.parentNode.insertBefore(
                                      n,
                                      this._objectElement
                                  ),
                ...
                i.prototype._createAndAppendIframe = function () {
                    let i, t, o, n, s, h, c, r, u, l, f;
                    if (!e(this._objectElement)) {
                        for (
                            i = this._objectElement.attributes,
                                ...
                                u = {
                                    ...
                                    "fr-CA": "Visualisation de données",
                                    ...
                                    ko: "데이터 비주얼리제이션",
                                    sv: "Datavisualisering",
                                    th: "การแสดงข้อมูลเป็นภาพ",
                                    "zh-CN": "数据可视化",
                                    "zh-TW": "資料可視化",
                                },
                            ...
                            i[t].specified &&
                                n.setAttribute(i[t].name, i[t].value);
                        return (
                            (n.style.cssText =
                                this._objectElement.style.cssText),
                            (n.style.margin = "0px"),
                            (n.style.padding = "0px"),
                            (n.style.border = "none"),
                            ...
                            this._ensurePlaceholderDiv() &&
                                this._placeholderDiv.appendChild(n),
                            n
                        );
                    }
                };
                window.tableau.Viz = function (n, t, i) {
                    ...
                    this._loadOrder = i["load-order"]
                        ? parseInt(i["load-order"], 10)
                        : 0;
                    this._filter = {};
                };
                window.tableau.vizs = [];
                window.tableau.createViz = function (n, t, f) {
                    ...
                    u(n) || (this.vizs[n] = e);
                    window.postMessage ||
                        (b ? (o.onreadystatechange = ft) : (o.onload = ft));
                };
                        ...
                        (this._filterArgs += "&" + encodeURIComponent(t) + "="),
                            (this._filterArgs +=
                                typeof n[t] == "string"
                                    ...
                                    : encodeURIComponent(n[t].join(",")));
                    this._iframe.src =
                        this._baseUrl + this._filterOpts + this._filterArgs;
                };
                ...
                window.tableau.Viz.prototype._enableVisibleRectCommunication =
                    function () {
                        nt() &&
                            this._iframe &&
                            this._iframe.contentWindow &&
                ...
                document.addEventListener
                    ...
                    : ((window.onload = h), (window.onmessage = l));
                (gt() || k) && ni();
